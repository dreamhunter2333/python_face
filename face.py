...
class Login(ttk.Frame):
    def __init__(self, win):
        ...
        self.url_face_button = ttk.Button(frame3, text="网络地址识别", width=15, command=self.url_face)
        ...
        self.facer = ttk.Label(frame4, text='', font=('Times', '20'))
        self.facer.pack()
    ...
    def url_face(self):
        ...
        facestr = img_api.faceu(url1, url2)
    ...
    def file_pic(self):
        facestr = img_api.facef(self.pic_path, self.pic_path2)
        self.facer.configure(text=str(facestr))
        self.pic()
